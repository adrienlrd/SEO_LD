...
| 17 | Générateur de meta titles optimisés par produit | 🟡 | ⏳ | |
| 18 | Générateur de meta descriptions optimisées par produit | 🟡 | ⏳ | |
| 19 | Générateur d'alt text intelligent basé sur nom produit + contexte | 🟡 | ⏳ | |
| 20 | Script `update_meta.py --apply` — push meta vers Shopify | 🟡 | ⏳ | |
| 21 | Script `update_alt_text.py --apply` — push alt text vers Shopify | 🟡 | ⏳ | |
...
| 24 | Système de rollback SQLite — annuler toute modification appliquée | 🔴 | ⏳ | |
